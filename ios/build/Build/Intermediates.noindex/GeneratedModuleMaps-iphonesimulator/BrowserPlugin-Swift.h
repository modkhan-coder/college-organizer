...
#ifndef BROWSERPLUGIN_SWIFT_H
#define BROWSERPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BrowserPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_ENUM_FWD_DECL(NSInteger, BrowserEvent)
@class NSURL;
@class UIColor;
@class SFSafariViewController;
@class UIPresentationController;
@class UIPopoverPresentationController;
SWIFT_CLASS("_TtC13BrowserPlugin7Browser")
...
@interface CAPBrowserPlugin : CAPPlugin <CAPBridgedPlugin>
