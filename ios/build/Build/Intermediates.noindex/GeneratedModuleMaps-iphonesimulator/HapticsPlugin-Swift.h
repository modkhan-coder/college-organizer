...
#ifndef HAPTICSPLUGIN_SWIFT_H
#define HAPTICSPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HapticsPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13HapticsPlugin7Haptics")
...
@interface HapticsPlugin : CAPPlugin <CAPBridgedPlugin>
