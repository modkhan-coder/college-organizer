...
#ifndef PUSHNOTIFICATIONSPLUGIN_SWIFT_H
#define PUSHNOTIFICATIONSPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PushNotificationsPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC23PushNotificationsPlugin24PushNotificationsHandler")
...
@interface PushNotificationsPlugin : CAPPlugin <CAPBridgedPlugin>
